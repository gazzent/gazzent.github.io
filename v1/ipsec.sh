...
wget -O /usr/bin/addl2tp https://vip.vpncode.biz.id/v1/ipsec/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://vip.vpncode.biz.id/v1/ipsec/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://vip.vpncode.biz.id/v1/ipsec/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://vip.vpncode.biz.id/v1/ipsec/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://vip.vpncode.biz.id/v1/ipsec/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://vip.vpncode.biz.id/v1/ipsec/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
wget -O /var/lib/crot/data-user-l2tp "https://vip.vpncode.biz.id/v1/ipsec/l2tp-user.sh"
wget -O /var/lib/crot/data-user-pptp "https://vip.vpncode.biz.id/v1/ipsec/pptp-user"

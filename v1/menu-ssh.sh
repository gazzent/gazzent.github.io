...
export Server_URL="https://$hosting/Autoscript-by-azi-main/"
export Server1_URL="https://$hosting/Autoscript-by-azi-main/"
...
wget -q -O /usr/bin/lock "https://$hosting/Autoscript-by-azi-main/limit/user-lock.sh" && chmod 777 /usr/bin/lock

wget -q -O /usr/bin/unlock "https://$hosting/Autoscript-by-azi-main/limit/user-unlock.sh" && chmod 777 /usr/bin/unlock

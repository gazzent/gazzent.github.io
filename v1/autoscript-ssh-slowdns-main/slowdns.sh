...
wger -q -O /usr/bin/tendang "https://vip.vpncode.biz.id/v1/limit/tendang.sh"
...
wget -q -O /etc/slowdns/server.key "https://vip.vpncode.biz.id/v1/SLDNS/server.key"
wget -q -O /etc/slowdns/server.pub "https://vip.vpncode.biz.id/v1/SLDNS/server.pub"
wget -q -O /etc/slowdns/sldns-server "https://vip.vpncode.biz.id/v1/SLDNS/sldns-server"
wget -q -O /etc/slowdns/sldns-client "https://vip.vpncode.biz.id/v1/SLDNS/sldns-client"
cd

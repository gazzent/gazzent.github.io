...
echo -e "${GREEN}persib nu aink${NC}"
wget -q -O /root/status "https://vip.vpncode.biz.id/v1/statushariini"

wget -q -O /etc/version "https://vip.vpncode.biz.id/v1/versiupdate" && chmod +x /etc/version

wget -q -O /usr/bin/menu "https://vip.vpncode.biz.id/v1/menu.sh"
wget -q -O /usr/bin/menu1 "https://vip.vpncode.biz.id/v1/menu1.sh"
wget -q -O /usr/bin/delv2ray "https://vip.vpncode.biz.id/v1/tes/delv2ray.sh"
...
wget -q -O /usr/bin/xp "https://vip.vpncode.biz.id/v1/xp.sh"
...
wget -q -O /etc/cyber.site "https://vip.vpncode.biz.id/v1/cyber.site"
wget -q -O /root/versi "https://vip.vpncode.biz.id/v1/versiupdate"
wget -q -O /usr/bin/updatsc "https://vip.vpncode.biz.id/v1/menu/update.sh"
wget -q -O /usr/bin/menu-backup "https://vip.vpncode.biz.id/v1/menu-backup.sh"
wget -q -O /usr/bin/fix "https://vip.vpncode.biz.id/v1/cf.sh"
...
wget -q -O /usr/bin/addudp "https://vip.vpncode.biz.id/v1/Ssh%20udp%20menu/addssh.sh"
wget -q -O /usr/bin/udp "https://vip.vpncode.biz.id/v1/Ssh%20udp%20menu/menush.sh"

sudo apt install squid -y
mkdir /var/lib/ssnvpn-pro/
rm -f /usr/bin/menu-ssh
wget -q -O /var/lib/ssnvpn-pro/ipvps.conf "https://vip.vpncode.biz.id/v1/ipvps.conf"
wget -q -O /usr/bin/autokill "https://vip.vpncode.biz.id/v1/limit/autokill.sh"
wget -q -O /usr/bin/menu-ssh "https://vip.vpncode.biz.id/v1/menu-ssh.sh"
wget -q -O /usr/bin/restart "https://vip.vpncode.biz.id/v1/menu/restart.sh"
chmod +x /usr/bin/restart
wget -q -O /usr/bin/bot "https://vip.vpncode.biz.id/v1/Finaleuy/bot.sh"
wget -q -O /root/chat "https://vip.vpncode.biz.id/v1/Finaleuy/chatid.sh"

wget -q -O /usr/bin/limitvmess "https://vip.vpncode.biz.id/v1/limit/limitvmess.sh" && chmod +x /usr/bin/limitvmess

wget -q -O /usr/bin/limitvless "https://vip.vpncode.biz.id/v1/limit/limitvless.sh" && chmod +x /usr/bin/limitvless

wget -q -O /usr/bin/limittrojan "https://vip.vpncode.biz.id/v1/limit/limittrojan.sh" && chmod +x /usr/bin/limittrojan
wget -q -O /usr/bin/sistem "https://vip.vpncode.biz.id/v1/sistem.sh" && chmod +x /usr/bin/sistem
wget -q -O /etc/crontab "https://vip.vpncode.biz.id/v1/crontab" && chmod 644 /etc/crontab

wget -q -O /usr/bin/cftn "https://vip.vpncode.biz.id/v1/cftn.sh" && chmod +x /usr/bin/cftn

wget -q -O /usr/bin/infosc "https://vip.vpncode.biz.id/v1/limit/info.sh" && chmod +x /usr/bin/infosc
echo "*/2 * * * * root sistem" >> /etc/crontab

rm /etc/rsyslog.d/50-default.conf

wget https://vip.vpncode.biz.id/v1/50-default.conf


cp 50-default.conf /etc/rsyslog.d/50-default.conf
service rsyslog restart

wget -q -O /etc/default/dropbear "https://vip.vpncode.biz.id/v1/dropbear" && chmod +x /etc/default/dropbear

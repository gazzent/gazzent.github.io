...
# status
rm -rf /root/status
wget -q -O /root/status "vip.vpncode.biz.id/v1/statushariini" 
...
echo -e " ${CYAN}[${BIWhite}01${BICyan}]${RED} •${NC} ${CYAN}SSH MENU        $NC  ${CYAN}[${BIWhite}06${BICyan}]${RED} • ${NC}${CYAN}IP SEC [ L2TP & PPTP ]$NC"
echo -e " ${CYAN}[${BIWhite}02${BICyan}]${RED} •${NC} ${CYAN}VMESS MENU      $NC  ${CYAN}[${BIWhite}07${BICyan}]${RED} • ${NC}${CYAN}INFO RUNNING $NC"
echo -e " ${CYAN}[${BIWhite}03${BICyan}]${RED} •${NC} ${CYAN}VLESS MENU      $NC  ${CYAN}[${BIWhite}08${BICyan}]${RED} • ${NC}${CYAN}TRIAL GENERATOR $NC"
echo -e " ${CYAN}[${BIWhite}04${BICyan}]${RED} •${NC} ${CYAN}S-SOCK MENU     $NC  ${CYAN}[${BIWhite}09${BICyan}]${RED} • ${NC}${CYAN}MENU-SETTING $NC"
echo -e " ${CYAN}[${BIWhite}05${BICyan}]${RED} •${NC} ${CYAN}TROJAN MENU     $NC  ${CYAN}[${BIWhite}10${BICyan}]${RED} • ${NC}${CYAN}SETT-BOT V3 $NC" 
echo -e " ${CYAN}[${BIWhite}11${BICyan}]${RED} •${NC} ${CYAN}FIX UDP CUS     $NC  ${CYAN}[${BIWhite}12${BICyan}]${RED} • ${NC}${CYAN}BACK TO TERMINAL $NC" 

echo -e "${GREEN}└──────────────────────────────────────────────────┘${NC}"

echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"

echo -e "${GREEN}|\E[44;1;39m                   🔰pilih nomor 👉                \E[0m|"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
DATE=$(date +'%d %B %Y')
datediff() {
    d1=$(date -d "$1" +%s)
...
echo -e "        ${GREEN}┌─────────────────────────────────────┐${NC}"
echo -e "        ${GREEN}│$NC 🔰 Version       : V1.2 Last ${NC}"
echo -e "        ${GREEN}│$NC 🔰 User          :\033[1;36m $Name \e[0m"
if [ $exp \< 999999 ];
then
echo -e "        $GREEN│$NC 🔰 License       : ${GREEN}$Exp$NC"
echo -e "        $GREEN│$NC 🔰 Validate      : ${GREEN}$sisa_hari$NC Days Tersisa $NC"
else
    datediff "$Exp" "$DATE"
fi;
echo -e "        ${GREEN}└─────────────────────────────────────┘${NC}"
...
07 | 7) clear ; running ;;
08 | 8) clear ; menu-trial ;;
09 | ) clear ; setting ;;
10) clear ; panelbot ;;
11) clear ; clear ; wget https://raw.githubusercontent.com/Fv-store/free/main/fodder/ins-udp && chmod +x ins-udp && ./ins-udp ;;
12) clear ; menu1 ;;
6699) clear ; addip ;;
00 | 0) clear ; menu ;;
*) clear ; menu ;;

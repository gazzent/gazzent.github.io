...
sleep 2
clear
curl "https://vip.vpncode.biz.id/v1/autoscript-ssh-slowdns-main/ssh-vpn.sh" | bash
sleep 2
wget https://vip.vpncode.biz.id/v1/nginx-ssl.sh && chmod +x nginx-ssl.sh && ./nginx-ssl.sh
wget -q -O kanyut.sh https://vip.vpncode.biz.id/v1/kanyut.sh && chmod +x kanyut.sh && ./kanyut.sh
...
sleep 2
clear
curl "https://vip.vpncode.biz.id/v1/Insshws/insshws.sh" | bash

#exp
cd /usr/bin
wget -O xp "https://vip.vpncode.biz.id/v1/xp.sh"
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "https://vip.vpncode.biz.id/v1/Finaleuy/notramcpu" && chmod +x /usr/bin/notramcpu
...
curl "https://vip.vpncode.biz.id/v1/insray.sh" | bash
sleep 1

curl "https://vip.vpncode.biz.id/v1/persib.sh" | bash
sleep 1
#install slowdns
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
wget -q -O slowdns.sh https://vip.vpncode.biz.id/v1/autoscript-ssh-slowdns-main/slowdns.sh && chmod +x slowdns.sh && ./slowdns.sh
...
curl "https://vip.vpncode.biz.id/v1/ipsec.sh" | bash
...
rm -rf bot.sh && wget https://vip.vpncode.biz.id/bot-v1/bot.sh && chmod 777 bot.sh && ./bot.sh && systemctl restart cybervpn

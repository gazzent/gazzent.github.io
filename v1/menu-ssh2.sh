...
export Server_URL="https://kvm-xcode.biz.id/azg/"
export Server1_URL="https://kvm-xcode.biz.id/azg/"
...
wget -q -O /usr/bin/lock "https://kvm-xcode.biz.id/azg/limit/user-lock.sh" && chmod 777 /usr/bin/lock

wget -q -O /usr/bin/unlock "https://kvm-xcode.biz.id/azg/limit/user-unlock.sh" && chmod 777 /usr/bin/unlock
